  ...
  return (
    ...
    <h1>Measurements</h1>
        <div className='measurement-inputs'>
            ...
            <br/>
            <input type="text" pattern='[0-9.]' placeholder={weightString} value={weight} onChange={handleWeight}/>
            <br/>
            <label>Height(mm):</label>
            <br/>
            <input type="text" pattern='[0-9.]' placeholder={sizeString} value={height} onChange={handleHeight}/>
            <br/>
            <label>Min Wall:</label>
            <br/>
            <input type="text" pattern='[0-9.]' placeholder="0.7 - 1.4" value={minWallThickness} onChange={handleMinWallThickness}/>
        </div>
    </section>
  )
}
